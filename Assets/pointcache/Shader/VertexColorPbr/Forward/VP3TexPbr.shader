    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float3 node_4318 = lerp(lerp(_BASE_Normal_var.rgb,_RED_Normal_var.rgb,node_2010),_GREEN_Normal_var.rgb,node_6577);
                float3 normalLocal = node_4318;
...
///////// Gloss:
                ...
                float node_4759 = lerp(lerp((_BASE_GlossMult*_BASE_Metallic_var.a),(_RED_GlossMult*_RED_Metallic_var.a),node_2010),(_GREEN_GlossMult*_GREEN_Metallic_var.a),node_6577);
                float gloss = node_4759;
                float perceptualRoughness = 1.0 - node_4759;
...
////// Specular:
                ...
                float node_8730 = lerp(lerp((_BASE_MetallicMult*_BASE_Metallic_var.r),(_RED_MetallicMult*_RED_Metallic_var.r),node_2010),(_GREEN_MetallicMult*_GREEN_Metallic_var.r),node_6577);
                float3 specularColor = node_8730;
                ...
                float3 node_8216 = lerp(lerp((_BASE_Albedo_var.rgb*_BASE_Color.rgb),(_RED_Albedo_var.rgb*_RED_Color.rgb),node_2010),(_GREEN_Albedo_var.rgb*_GREEN_Color.rgb),node_6577);
                float3 diffuseColor = node_8216; // Need this for specular when using metallic
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float4 _GREEN_Metallic_var = tex2D(_GREEN_Metallic,TRANSFORM_TEX(i.uv0, _GREEN_Metallic));
                float node_8730 = lerp(lerp((_BASE_MetallicMult*_BASE_Metallic_var.r),(_RED_MetallicMult*_RED_Metallic_var.r),node_2010),(_GREEN_MetallicMult*_GREEN_Metallic_var.r),node_6577);
                diffColor = DiffuseAndSpecularFromMetallic( diffColor, node_8730, specColor, specularMonochrome );
                float node_4759 = lerp(lerp((_BASE_GlossMult*_BASE_Metallic_var.a),(_RED_GlossMult*_RED_Metallic_var.a),node_2010),(_GREEN_GlossMult*_GREEN_Metallic_var.a),node_6577);
                float roughness = 1.0 - node_4759;
